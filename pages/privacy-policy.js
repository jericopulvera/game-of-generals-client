const Page = () => (
  <div>
    <h1>Privacy Policy for Strength In Number</h1>

    <p>
      At Strength In Number, accessible from https://strength-in-number.ml, one
      ...
      Strength In Number and how we use it.
    </p>

    <p>
      If you have additional questions or require more information about our
      Privacy Policy, do not hesitate to contact us through email at
      jerico.pulvera01z@gmail.com
    </p>

    <h2>Log Files</h2>

    <p>
      Strength In Number follows a standard procedure of using log files. These
    ...
    <p>
      ...
      advertising partners of Strength In Number. Our Privacy Policy was created
    ...
    <p>
      ...
      advertisements and links that appear on Strength In Number, which are sent
    ...
    <p>
      Note that Strength In Number has no access to or control over these
    ...
    <p>
      Strength In Number's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Strength In Number does not knowingly collect any Personal Identifiable
    ...
    <p>
      ...
      and/or collect in Strength In Number. This policy is not applicable to any
